...
export default function Estatisticas({ id }: Props) {
  ...
  const { carregarTorneio, torneioResponse } = useTorneioEstatistica()
  ...
  return (
    <Container>
      <ModalEstatisticaTorneio torneioId={id} key="modalEstatistica" jogador={currentJogadorEstatistica} show={openModalEstatistica} handleClose={() => setOpenModalEstatistica(false)} />
      <ActionsContainer>
        <SearchInput>
          <input
            type="text"
