...
export const coachCreateSchema = yup.object().shape({
    ...
    cpf: yup.string()
        ...
        .test("cpf-valido", "CPF inválido", (value) => validarCPF(value || "")), // Valida CPF
...
export const coachUpdateSchema = yup.object().shape({
